...
const UI = {
  en: {
    ...
    'coffer.commonsOpened': 'A chime supply box — a full blueprint, and the makings for one. Chimes mark friendly rest stops.',
    'coffer.commonsContext': 'from the supply box at the Repair Commons',
  ...
  zh: {
    ...
    'coffer.commonsOpened': '风铃补给箱——一张完整图样，和做一件的材料。风铃标记着友好的歇脚处。',
    'coffer.commonsContext': '来自维修角的补给箱',
